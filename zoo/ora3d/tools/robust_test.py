...
def main():
    ...
    assert cfg.get('corruptions', None), "Specify corruption type from MotionBlur, Fog, Snow,\
            ColorQuant, Brightness, LowLight, CameraCrash, FrameLost in the config file"
